    ...
    <el-card class="box-card" style="width: 400px">
      ...
      <div>
        <div style="display: flex; justify-content: center">
          <el-upload action="/admin/userface" :headers="header" :data="admin" show-file-list="false" :on-success="onSuccess">
          <img
            title="点击修改用户头像"
            src="admin.userFace"
        ...
        <div>
          ...
          <div>
            电话号码: <el-tag>{{ admin.phone }}</el-tag>
          </div>
          <div>
...
export default {
  ...
  methods: {
    ...
    showUpdatePasswordView() {
      this.showUpdatePasswordView = true;
    },
    updateAdminInfo() {
