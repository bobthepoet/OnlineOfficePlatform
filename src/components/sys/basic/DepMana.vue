    ...
    <div style="width: 40%">
      ...
      <el-tree :data="deptData"
        ...
        <span class="custom-tree-node" slot-scope="{node, data}" style="display: flex;justify-content: space-between;align-items: center;width: 100%">
          <span>{{data.name}}</span>
          <span>
            <el-button @click="fnShowAddDept(data)" type="text" icon="el-icon-circle-plus"></el-button>
            <el-button @click="fnDeleteDept(data)" type="text" style="color: #FF0000" icon="el-icon-delete"></el-button>
          </span>
        </span>
      </el-tree>
